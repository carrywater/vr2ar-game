...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.oculus.AR_VR_FINAL
...
%ADB% %DEVICE% shell pm grant com.oculus.AR_VR_FINAL android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.oculus.AR_VR_FINAL android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
